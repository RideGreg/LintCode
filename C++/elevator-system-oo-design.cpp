...
enum Direction { // used in ExternalRequest class
    _UP, _DOWN
};

enum Status { // used in Elevator class
    UP, DOWN, IDLE
};
...
class Elevator {
    ...
    public :
        Elevator(int n) {
            status = IDLE;
            // level in Request is 1-based, stop and currLevel are 0-based.
            for (int i = 0; i < n; ++i) {
